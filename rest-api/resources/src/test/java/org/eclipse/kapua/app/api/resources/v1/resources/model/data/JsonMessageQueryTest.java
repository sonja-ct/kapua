...
public class JsonMessageQueryTest extends Assert {
    ...
    KapuaId kapuaId;
    JsonMessageQuery jsonMessageQuery1;
    JsonMessageQuery jsonMessageQuery2;
    ...
    public void jsonMessageQueryWithoutParameterTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery.getScopeId());
        assertEquals("Expected and actual values should be the same.", StorableFetchStyle.SOURCE_FULL, jsonMessageQuery.getFetchStyle());
        assertNotNull("NotNull expected.", jsonMessageQuery.getFetchAttributes());
        assertFalse("False expected.", jsonMessageQuery.isAskTotalCount());
    }
    ...
    public void setAndGetScopeIdTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery1.getScopeId());
        assertNull("Null expected.", jsonMessageQuery2.getScopeId());
    }
    ...
    public void setAndGetPredicateTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery1.getPredicate());
        assertNull("Null expected.", jsonMessageQuery2.getPredicate());
    }
    ...
    public void setAndGetOffsetTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery1.getOffset());
        assertNull("Null expected.", jsonMessageQuery2.getOffset());
    }
    ...
    public void setAndGetLimitTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery1.getLimit());
        assertNull("Null expected.", jsonMessageQuery2.getLimit());
    }
    ...
    public void setAndGetFetchStyleTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery1.getFetchStyle());
        assertNull("Null expected.", jsonMessageQuery2.getFetchStyle());
    }
    ...
    public void setGetAndAddFetchAttributesTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery1.getFetchAttributes());
        assertNull("Null expected.", jsonMessageQuery2.getFetchAttributes());
    }
    ...
    public void setAndGetSortFieldsTest() {
        ...
        assertNull("Null expected.", jsonMessageQuery1.getSortFields());
        assertNull("Null expected.", jsonMessageQuery2.getSortFields());
    }

    @Test
    public void getIncludesTest() {
        for (StorableFetchStyle fetchStyle : fetchStyles) {
            assertNotNull("NotNull expected.", jsonMessageQuery1.getIncludes(fetchStyle));
            assertNotNull("NotNull expected.", jsonMessageQuery2.getIncludes(fetchStyle));
        }
    }
    ...
    public void getExcludesTest() {
        for (StorableFetchStyle fetchStyle : fetchStyles) {
            assertNotNull("NotNull expected.", jsonMessageQuery1.getExcludes(fetchStyle));
            assertNotNull("NotNull expected.", jsonMessageQuery2.getExcludes(fetchStyle));
        }
    }
