...
public class SubjectUnathorizedExceptionMapperTest extends Assert {

    SubjectUnathorizedExceptionMapper subjectUnathorizedExceptionMapper;

    @Before
    public void initialize() {
        subjectUnathorizedExceptionMapper = new SubjectUnathorizedExceptionMapper();
    }
